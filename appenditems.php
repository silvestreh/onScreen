...
<header>
  ...
  <p>This demo shows how you can animate elements that are entering the viewport and append new elements when you reach the page's footer.</p>
</header>
<section class="posts">
  <article class="post">
  ...
  <footer><p>You reached the bottom. I'll load more post :-)</p></footer>
</section>
    ...
    */
    $('footer').onScreen({
      doIn: function() {
        ...
        $template.css({
          top: 40,                  // We're cloning a visible element and
